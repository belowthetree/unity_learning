...
// 
// 		if (AssetDatabase.CopyAsset(AssetDatabase.GetAssetPath(FXMakerMain.inst.GetOriginalEffectPrefab().GetComponent<Renderer>().sharedMaterial.mainTexture), filename))
