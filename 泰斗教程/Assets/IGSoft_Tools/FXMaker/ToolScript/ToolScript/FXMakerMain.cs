...
// 		Debug.Log(NgAssembly.GetPropertyValue(new SerializedObject(transform), "m_LocalEulerAnglesHint.x"));
// 		if (FXMakerHierarchy.inst.GetSelectedGameObject() != null && FXMakerHierarchy.inst.GetSelectedGameObject().GetComponent<Renderer>() != null)
// 			NgAssembly.GetPropertis(FXMakerHierarchy.inst.GetSelectedGameObject().GetComponent<Renderer>());
