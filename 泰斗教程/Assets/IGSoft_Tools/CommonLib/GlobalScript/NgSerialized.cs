...
// 			default: Debug.Log("Undefile propertyType - SetPropertyValue " + sp.name); break;
	...
	public static bool IsValidCopy(Component tarCom, Component srcCom)
	{
		...
		if (srcCom.ToString().Contains("EllipsoidGetComponent<ParticleEmitter>()") || srcCom.ToString().Contains("MeshGetComponent<ParticleEmitter>()"))
		{
			return srcCom.ToString().Contains("EllipsoidGetComponent<ParticleEmitter>()") == srcCom.ToString().Contains("EllipsoidGetComponent<ParticleEmitter>()");
		}
		return true;
	}
	...
	{
		if (srcCom.ToString().Contains("EllipsoidGetComponent<ParticleEmitter>()"))
			return tarObject.AddComponent<EllipsoidParticleEmitter>();
		if (srcCom.ToString().Contains("MeshGetComponent<ParticleEmitter>()"))
...
// 			return IsPropertyValue(new SerializedObject(particleCom as GetComponent<ParticleEmitter>()), "m_Mesh");
		}
